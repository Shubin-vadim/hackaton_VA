...
import app.Models.RecognationObjectsModel
...
class DataModel:
 # инициализация объектов других классов
    def __init__(self):
        ...
        self.recogn = app.Models.RecognationObjectsModel.RecognationObjectsModel()

    # основная функция получения ответа и действия пользователя
    def get_answer(self, text):
        filname = r'app/config/commands.json'
