...
__all__ = [
    'DISPID_SRRTLength', 'DISPID_SMSALineId', 'DISPID_SRCEAudioLevel',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechPhraseProperties', 'SAFTCCITT_ALaw_44kHzStereo',
    'SRTExtendableParse', 'DISPID_SPEsCount',
    'SpeechCategoryAppLexicons', 'ISpeechPhraseReplacement',
    'DISPID_SPPName', 'DISPID_SPEEngineConfidence', 'SECFDefault',
    'SPSModifier', 'DISPID_SPIElements', 'SpeechTokenKeyAttributes',
    'ISpRecoCategory', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRCEInterference', 'DISPID_SASState',
    'DISPID_SRSCurrentStreamNumber', 'eLEXTYPE_APP',
    'ISpeechRecoGrammar', 'DISPID_SpeechRecoContext', 'SVP_21',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechRecoContextEvents',
    'SAFT11kHz16BitStereo', 'DISPID_SPAPhraseInfo',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRRTimes',
    'SVP_10', 'SPPS_RESERVED3', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRCCreateGrammar', 'SpeechGrammarTagWildcard',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRDisplayUI',
    'SPRS_INACTIVE', 'SpNullPhoneConverter', 'DISPID_SLPType',
    'SAFTADPCM_44kHzMono', 'DISPID_SLGetWords', 'DISPID_SpeechAudio',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPPParent', 'DISPID_SLWsItem',
    'DISPID_SRGSetWordSequenceData', 'SPWT_PRONUNCIATION',
    'DISPID_SPRuleFirstElement', 'DISPID_SLGenerationId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRStatus', 'SREStreamStart', 'SPAS_STOP',
    'SpeechFormatType', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCERecognition', 'SAFT48kHz16BitMono', 'SPINTERFERENCE',
    'DISPID_SRRSetTextFeedback', 'SBOPause', 'SVEViseme',
    'DISPID_SPRFirstElement', 'SPEI_RESERVED6', 'SPAR_Unknown',
    'SVSFPersistXML', 'SP_VISEME_12', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE16', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRGetPropertyNumber', 'SPFM_OPEN_READWRITE',
    '_ISpeechVoiceEvents', 'SPAS_RUN', 'SREPhraseStart',
    'SRERecognition', 'SASStop', 'DISPID_SPRuleId',
    'SGPronounciation', 'DISPID_SLWWord', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRRRecoContext', 'SPCS_DISABLED', '_RemotableHandle',
    'DISPID_SVStatus', 'SPRST_ACTIVE', 'DISPID_SPILanguageId',
    'SDA_No_Trailing_Space', 'SpCompressedLexicon',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpShortcut', 'DISPID_SVPause',
    'SpeechDiscardType', 'SpeechTokenValueCLSID', 'DISPID_SVVoice',
    'SP_VISEME_8', 'DISPID_SVSLastStreamNumberQueued',
    'SPCONTEXTSTATE', 'DISPID_SVGetAudioOutputs',
    'SPSHORTCUTPAIRLIST', 'SAFT22kHz16BitMono', 'SpeechVisemeFeature',
    'DISPID_SOTIsUISupported', 'SPPHRASEREPLACEMENT',
    'SpCustomStream', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRCEEnginePrivate', 'SpeechWordType',
    'ISpeechXMLRecoResult', 'SPEI_START_SR_STREAM', 'SPSFunction',
    'eLEXTYPE_PRIVATE20', 'SAFTCCITT_uLaw_8kHzMono', 'STCAll',
    'eLEXTYPE_RESERVED6', 'SP_VISEME_6', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechRecoResult', 'DISPID_SOTsItem', 'SPDATAKEYLOCATION',
    'SFTInput', 'ISpeechPhraseAlternate', 'DISPIDSPTSI_ActiveLength',
    'SP_VISEME_4', 'SSTTWildcard', 'SAFTADPCM_22kHzMono',
    'eLEXTYPE_PRIVATE18', 'DISPID_SLAddPronunciation',
    'DISPID_SVAudioOutputStream', 'SGRSTTTextBuffer',
    'SSTTTextBuffer', 'SVSFVoiceMask', 'SPVPRI_OVER', 'SVEPhoneme',
    'SPRECOGNIZERSTATUS', 'SAFTGSM610_22kHzMono', 'SDTAlternates',
    'SWTDeleted', 'eWORDTYPE_DELETED', 'DISPID_SVEventInterests',
    'SP_VISEME_5', 'SPAUDIOBUFFERINFO', 'DISPID_SPCLangId',
    'DISPID_SGRsItem', 'DISPID_SVSLastBookmark', 'SECFNoSpecialChars',
    'DISPID_SpeechLexiconProns', 'SPLO_STATIC', 'SAFTText',
    'DISPID_SVEEnginePrivate', 'SSTTDictation', 'SVSFDefault',
    'SRSActive', 'SPFILEMODE', 'ISpeechResourceLoader', 'SPRECOSTATE',
    'SPEVENTENUM', 'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE6',
    'ISpStreamFormat', 'DISPID_SLRemovePronunciation',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRCVoicePurgeEvent', 'SPSLMA',
    'DISPID_SpeechPhraseRule', 'SDKLCurrentUser',
    'DISPID_SRRTTickCount', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPIEnginePrivateData',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPISaveToMemory',
    'SPAS_PAUSE', 'SDTRule', 'DISPID_SGRSTs_NewEnum', 'SPGS_ENABLED',
    'IStream', 'eLEXTYPE_RESERVED9', 'DISPID_SGRAttributes',
    'IInternetSecurityMgrSite', 'SPVPRIORITY',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SAFType', 'SVP_17',
    'SPWAVEFORMATTYPE', 'SDTAll', 'ISpeechPhraseReplacements',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechRegistryLocalMachineRoot',
    'SPWORDTYPE', 'SAFT22kHz8BitStereo', 'SAFT22kHz8BitMono',
    'SAFTGSM610_11kHzMono', 'DISPID_SVIsUISupported',
    'DISPID_SOTGetAttribute', 'SpMMAudioIn', 'SGLexical',
    'Speech_Max_Word_Length', 'SPAUDIOSTATUS',
    'SPEI_END_INPUT_STREAM', 'SAFT44kHz8BitStereo',
    'ISpeechPhraseRule', 'eLEXTYPE_RESERVED10', 'SRESoundStart',
    'DISPID_SLGetPronunciations', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SAVolume', 'ISpObjectWithToken', 'DISPID_SPRuleParent',
    'SpeechAudioFormatType', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRCVoice', 'ISpGrammarBuilder', 'DISPID_SPELexicalForm',
    'SRAExport', 'SP_VISEME_11', 'SPPS_RESERVED2',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVEPrivate',
    'STCRemoteServer', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFT22kHz16BitStereo', 'SPBOOKMARKOPTIONS',
    'DISPID_SRCERecognizerStateChange', 'SpeechDisplayAttributes',
    'DISPID_SPRuleEngineConfidence', 'SAFT32kHz16BitStereo',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCEPropertyStringChange',
    'SPEI_PHONEME', 'DISPID_SGRClear', 'eLEXTYPE_PRIVATE9',
    'SAFT48kHz8BitMono', 'DISPID_SVSpeakStream',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechRecognizerStatus', 'SPEVENTSOURCEINFO',
    'SAFT12kHz8BitMono', 'SVP_9', 'SPCT_SUB_COMMAND',
    'ISpStreamFormatConverter', 'SPSVerb', 'DISPID_SVSLastBookmarkId',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRAudioInputStream',
    'SpResourceManager', 'SpeechVoiceCategoryTTSRate', 'SVF_None',
    'DISPID_SpeechCustomStream', 'SAFT24kHz16BitMono',
    'SPSInterjection', 'SPWORDLIST', 'SPADAPTATIONRELEVANCE',
    'SpeechGrammarWordType', 'SVP_0', 'DISPID_SPRuleConfidence',
    'STSF_LocalAppData', 'SPEI_TTS_PRIVATE', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHT_EMAIL',
    'SREStateChange', 'SPPARTOFSPEECH', 'DISPID_SRCESoundEnd',
    'SPDKL_CurrentConfig', 'ISpeechGrammarRuleStateTransitions',
    'SpObjectToken', 'SpeechCategoryAudioIn', 'SREAllEvents',
    'SAFTADPCM_44kHzStereo', 'SP_VISEME_0', 'SVP_8',
    'SREPropertyStringChange', 'SDTReplacement', 'ISpRecognizer2',
    'DISPID_SPPConfidence', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPRuleChildren', 'SPEI_MAX_TTS',
    'ISpeechLexiconPronunciation', 'DISPID_SPEPronunciation',
    'DISPID_SVEBookmark', 'SpeechRunState', 'SPEI_RESERVED3',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechPhraseElement', 'DISPID_SGRSTNextState',
    'SPPHRASERULE', 'SAFTCCITT_ALaw_8kHzMono', 'SPINTERFERENCE_NONE',
    'SpAudioFormat', 'DISPID_SDKOpenKey', 'SVPNormal',
    'SpeechAddRemoveWord', 'SpeechStreamFileMode', 'SGDSInactive',
    'SAFTNoAssignedFormat', 'SPPHRASEPROPERTY',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRCEHypothesis',
    'SpeechTokenShellFolder', 'ISpNotifySink', 'WAVEFORMATEX',
    'SPFM_OPEN_READONLY', 'DISPID_SABufferNotifySize',
    'SPSHORTCUTTYPE', 'SPFM_CREATE',
    'DISPID_SpeechObjectTokenCategory', 'SPCATEGORYTYPE',
    'SpeechLexiconType', 'DISPID_SRRPhraseInfo',
    'DISPID_SRGCmdLoadFromObject', 'eWORDTYPE_ADDED',
    'DISPID_SPERetainedStreamOffset', 'SASClosed', 'SLOStatic',
    'SAFTGSM610_44kHzMono', 'ISpeechRecognizer', 'ISpeechAudioFormat',
    'SREAudioLevel', 'DISPID_SAStatus', 'DISPID_SVEStreamEnd',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechBaseStream',
    'SP_VISEME_18', 'ISpeechPhraseElement', 'DISPID_SMSAMMHandle',
    'DISPID_SMSSetData', 'SINoise', 'LONG_PTR', 'DISPID_SLPPhoneIds',
    'SPXRO_SML', 'DISPID_SRProfile', 'DISPID_SRIsUISupported',
    'SP_VISEME_3', 'SPRST_INACTIVE', 'DISPID_SpeechPhraseElements',
    'SP_VISEME_15', 'STCInprocServer', 'DISPID_SVAudioOutput',
    'SWPUnknownWordPronounceable', 'SpMemoryStream',
    'DISPID_SRGetPropertyString', 'DISPID_SRGSetTextSelection',
    'DISPID_SpeechMemoryStream', 'SREHypothesis', 'SECHighConfidence',
    'SECFIgnoreWidth', 'DISPID_SPAStartElementInResult',
    'DISPID_SLWsCount', 'DISPID_SRCERequestUI', 'SpInProcRecoContext',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechRecoResult2',
    'eLEXTYPE_PRIVATE13', 'SPGRAMMARWORDTYPE', 'SP_VISEME_16',
    'DISPID_SVEViseme', 'SVP_12', 'SLODynamic', 'SPRST_NUM_STATES',
    'DISPID_SPRs_NewEnum', 'SpFileStream',
    'DISPID_SOTCEnumerateTokens', 'SPPS_Unknown', 'SPEVENT',
    'DISPID_SPPValue', 'SPRULE', 'SAFT12kHz8BitStereo',
    'DISPID_SRCEPropertyNumberChange', 'SPLO_DYNAMIC',
    '__MIDL_IWinTypes_0009', 'DISPID_SASCurrentDevicePosition',
    'SWPUnknownWordUnpronounceable', 'SpeechEngineConfidence',
    'SECNormalConfidence', 'DISPID_SASNonBlockingIO',
    'eLEXTYPE_PRIVATE5', 'SITooQuiet', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVEVoiceChange', 'ISpRecoGrammar', 'SDTAudio',
    'eLEXTYPE_USER', 'DISPID_SLWPronunciations',
    'ISpeechGrammarRules', 'DISPID_SPEAudioSizeTime',
    'SVEVoiceChange', 'DISPID_SRRAudio', 'DISPID_SGRsCommitAndSave',
    'SpeechRetainedAudioOptions', 'STSF_AppData',
    'eLEXTYPE_RESERVED7', 'SVP_20', 'SVSFPurgeBeforeSpeak',
    'SPPROPERTYINFO', 'ISpeechVoiceStatus', 'ISpNotifySource',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPRuleName', 'SPSNoun',
    'DISPID_SPRsItem', 'DISPID_SRSAudioStatus',
    'DISPID_SRCERecognitionForOtherContext', 'SPPS_Noun', 'SPAR_High',
    'DISPID_SRCSetAdaptationData', 'ISpeechTextSelectionInformation',
    'DISPID_SpeechRecognizer', 'SpStreamFormatConverter',
    'DISPID_SPRuleNumberOfElements', 'SpWaveFormatEx',
    'DISPID_SRGState', 'Speech_Default_Weight',
    'SpeechRuleAttributes', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechPhraseRules', 'SVPAlert', 'ISpeechObjectToken',
    'eLEXTYPE_PRIVATE8', 'SAFT8kHz8BitStereo',
    'SpeechRegistryUserRoot', 'SAFT32kHz8BitStereo', 'DISPID_SGRsAdd',
    'SPEI_SR_PRIVATE', 'DISPID_SVEStreamStart',
    'SAFT16kHz16BitStereo', 'SpeechCategoryRecognizers',
    'DISPID_SRIsShared', 'DISPID_SRCEBookmark', 'ISpeechRecoResult2',
    'DISPIDSPRG', 'SPRECOCONTEXTSTATUS', 'ISpPhraseAlt',
    'eLEXTYPE_PRIVATE11', 'DISPID_SOTRemove', 'ISpeechPhoneConverter',
    'SpeechPropertyAdaptationOn', 'SBONone', 'SVSFNLPMask',
    'SSFMCreate', 'STSF_FlagCreate', 'DISPID_SAFSetWaveFormatEx',
    'SRAImport', 'SPRULESTATE', 'SAFT12kHz16BitMono',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_RESERVED4', 'SVP_2',
    'DISPID_SAEventHandle', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPIDSPTSI', 'SpPhoneConverter', 'SASRun', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPRules_NewEnum', 'SPWORDPRONUNCIATION',
    'SpeechWordPronounceable', 'SpeechTokenContext',
    'ISpeechPhraseProperties', 'SPEI_HYPOTHESIS',
    'SpeechAudioFormatGUIDWave', 'DISPID_SPCIdToPhone',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpUnCompressedLexicon',
    'SPEI_REQUEST_UI', 'SPSTREAMFORMATTYPE', 'DISPID_SPRsCount',
    'DISPID_SRRTStreamTime', 'DISPID_SpeechAudioStatus',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SGRSTsItem',
    'SPAUDIOSTATE', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCPause',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechRecoProfileProperties', 'SPTEXTSELECTIONINFO',
    'SRTAutopause', 'DISPID_SPEs_NewEnum', 'SpeechAudioVolume',
    'SpeechEngineProperties', 'DISPID_SPERequiredConfidence',
    'SpeechAudioProperties', 'SPEI_UNDEFINED', 'SP_VISEME_2',
    'DISPID_SOTCDefault', 'SAFT44kHz8BitMono', 'SPGS_DISABLED',
    'SPSEMANTICFORMAT', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVSLastResult', 'DISPID_SOTId', 'SVSFNLPSpeakPunc',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRSSupportedLanguages',
    'ISpeechGrammarRule', 'SDTPronunciation', 'DISPID_SOTCId',
    'SPCT_COMMAND', 'SAFT8kHz16BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SDKCreateKey',
    'SAFTDefault', 'SAFTNonStandardFormat', 'Speech_StreamPos_Asap',
    'DISPID_SPPFirstElement', 'DISPID_SGRsFindRule',
    'SpeechCategoryRecoProfiles', 'ISpeechPhraseRules',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT44kHz16BitStereo',
    'SAFT11kHz16BitMono', 'SVSFParseMask', 'SPEI_START_INPUT_STREAM',
    'SDKLDefaultLocation', 'ISpVoice', 'DISPID_SDKGetlongValue',
    'SGRSTTRule', 'SPEI_SOUND_END', 'DISPID_SDKSetLongValue',
    'ISpRecognizer', 'SPAS_CLOSED', 'SPEI_SR_BOOKMARK',
    'SPPS_SuppressWord', 'SVSFIsXML', 'ISpeechDataKey',
    'DISPID_SRCreateRecoContext', 'SAFT12kHz16BitStereo',
    'tagSPPROPERTYINFO', 'SPPS_Function',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPPEngineConfidence',
    'DISPID_SOTCSetId', 'ISpeechObjectTokenCategory',
    'DISPID_SPEAudioStreamOffset', 'SPAO_NONE', 'DISPID_SVSpeak',
    'SPEI_SR_AUDIO_LEVEL', 'SAFT24kHz8BitMono', 'SVP_3',
    'eLEXTYPE_PRIVATE12', 'SRAInterpreter', 'DISPID_SABufferInfo',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechVoiceEvent',
    'DISPID_SGRSTPropertyName', 'DISPID_SGRId', 'SpeechAudioState',
    'DISPID_SRCResume', 'DISPID_SRCCreateResultFromMemory',
    'SpMMAudioOut', 'DISPID_SRCEEndStream', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRSetPropertyString', 'ISpStream',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SGRsCount', 'DISPID_SPRulesItem',
    'DISPID_SVSInputSentenceLength', 'ISpeechAudioBufferInfo',
    'ISpeechFileStream', 'SRTSMLTimeout', 'SPVPRI_ALERT',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_MORPHOLOGY',
    'SPEI_TTS_BOOKMARK', 'SGRSTTEpsilon', 'IEnumSpObjectTokens',
    'ISpeechPhraseInfo', 'SRADynamic', 'SSSPTRelativeToStart',
    'SpeechTokenKeyUI', 'SRESoundEnd',
    'ISpeechGrammarRuleStateTransition', 'SPEI_MIN_SR',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechVoicePriority', 'SLTApp',
    'DISPID_SOTCategory', 'SpNotifyTranslator',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SLPs_NewEnum',
    'DISPID_SLPPartOfSpeech', 'SPDKL_LocalMachine',
    'ISpPhoneticAlphabetConverter', 'DISPID_SABIEventBias',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPRS_ACTIVE', 'SRADefaultToActive',
    'DISPID_SVDisplayUI', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVSRunningState', 'DISPID_SREmulateRecognition',
    'SAFTGSM610_8kHzMono', 'DISPID_SPAs_NewEnum', 'SPCS_ENABLED',
    'ISpEventSource', 'DISPID_SRCRetainedAudio',
    'ISpeechObjectTokens', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRSTPropertyId',
    'SDKLCurrentConfig', 'ISpeechPhraseAlternates',
    'SPEI_RECOGNITION', 'ISpeechMemoryStream', 'SSFMCreateForWrite',
    'SPSHT_Unknown', 'ISpSerializeState', 'DISPID_SMSGetData',
    'SP_VISEME_7', 'DISPID_SGRsCommit', 'DISPID_SDKEnumKeys',
    'ISpXMLRecoResult', 'SPPHRASEELEMENT', 'ISpeechPhraseElements',
    'ISpeechCustomStream', 'DISPID_SpeechObjectToken',
    'DISPID_SASetState', 'DISPID_SRGReset', 'SVSFParseSsml',
    'DISPID_SOTSetId', 'DISPID_SOTCreateInstance',
    'DISPID_SGRAddState', 'ISpeechPhraseProperty',
    'SPEI_PHRASE_START', 'SPWT_LEXICAL', 'DISPID_SGRInitialState',
    'DISPID_SVEPhoneme', 'SPSERIALIZEDPHRASE',
    'SGDSActiveWithAutoPause', 'SpeechGrammarState',
    'SPWORDPRONOUNCEABLE', 'DISPID_SWFEChannels',
    'DISPID_SDKSetBinaryValue', 'SVEAllEvents',
    'DISPID_SRCRequestedUIType', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SLWLangId', 'SVP_4', 'SVP_19',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRCEStartStream',
    'DISPID_SpeechDataKey', 'DISPID_SFSOpen',
    'DISPID_SRGDictationLoad', 'SPEI_RESERVED1', 'SPSUnknown',
    'DISPID_SOTDataKey', 'DISPID_SPIEngineId',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRSTType',
    'DISPID_SRRSaveToMemory', 'DISPID_SRCEAdaptation',
    'DISPID_SRGRules', 'SPSEMANTICERRORINFO', 'DISPID_SLWType',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVSFParseSapi', 'SPVOICESTATUS',
    'SpeechLoadOption', 'DISPID_SFSClose', 'SVEEndInputStream',
    'SVESentenceBoundary', 'IEnumString', 'SAFT48kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SBSSeek',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE7',
    'SPBO_TIME_UNITS', 'SPEI_RESERVED2', 'SPEI_SOUND_START',
    'SpObjectTokenCategory', 'SPSSuppressWord', 'SpPhraseInfoBuilder',
    'SGRSTTDictation', 'ISpRecoGrammar2',
    'SpeechEmulationCompareFlags', 'DISPID_SGRSTsCount',
    'DISPID_SWFEExtraData', 'SPSNotOverriden',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPIReplacements',
    'ISpeechPhraseInfoBuilder', 'SREBookmark', 'DISPID_SRCRecognizer',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPIGrammarId',
    'DISPID_SPIProperties', 'SpSharedRecoContext', 'SPBO_NONE',
    '_ISpeechRecoContextEvents', 'DISPID_SRCESoundStart',
    'SPEI_END_SR_STREAM', 'SGRSTTWildcard', 'ISpeechLexiconWords',
    'DISPID_SpeechGrammarRules', 'SRSInactive', 'ISpMMSysAudio',
    'SPPS_NotOverriden', 'SVPOver',
    'SpeechGrammarTagUnlimitedDictation', 'SVP_18', 'ISpShortcut',
    'DISPID_SLAddPronunciationByPhoneIds', 'SRSEIsSpeaking',
    'SP_VISEME_9', 'DISPID_SGRAddResource',
    'DISPID_SVSInputWordPosition', 'SpeechMicTraining',
    'DISPID_SLWs_NewEnum', 'SPSMF_SAPI_PROPERTIES',
    'SpeechBookmarkOptions', 'DISPID_SRGCmdSetRuleIdState',
    'SVEBookmark', 'DISPID_SDKGetBinaryValue',
    'DISPID_SWFESamplesPerSec', 'SAFT44kHz16BitMono',
    'ISpeechBaseStream', 'DISPID_SCSBaseStream',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPAsCount', 'SPLOADOPTIONS',
    'SPPS_RESERVED1', 'SGDisplay', 'SP_VISEME_13', 'ISpRecoContext2',
    'SpeechPartOfSpeech', 'SPGS_EXCLUSIVE', 'SPWF_INPUT',
    'SSFMOpenReadWrite', 'Speech_Max_Pron_Length',
    'DISPID_SpeechLexiconWord', 'SpeechPropertyResourceUsage',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SMSADeviceId', 'DISPID_SPRText', 'SPEI_MAX_SR',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SPEAudioSizeBytes',
    'SPEI_WORD_BOUNDARY', 'DISPID_SpeechPhraseAlternates',
    'ISpResourceManager', 'SP_VISEME_21',
    'DISPID_SRSNumberOfActiveRules', 'SVP_15', 'DISPID_SRCState',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpProperties', 'SPEI_VISEME',
    'SAFTADPCM_11kHzMono', 'SpeechInterference',
    'SpeechStreamSeekPositionType', 'SREAdaptation',
    'DISPID_SPPChildren', 'DISPID_SVSVisemeId',
    'ISpeechLexiconPronunciations', 'SpeechGrammarTagDictation',
    'SPPS_RESERVED4', 'DISPID_SRGDictationSetState', 'SFTSREngine',
    'SpeechPropertyComplexResponseSpeed', 'SRARoot',
    'SPEI_PROPERTY_STRING_CHANGE', 'SASPause', 'tagSTATSTG',
    'SAFT11kHz8BitMono', 'STSF_CommonAppData', 'DISPID_SGRSRule',
    'SVEWordBoundary', 'SAFTCCITT_uLaw_8kHzStereo',
    'SECFIgnoreKanaType', 'DISPID_SRRAlternates', 'SPPS_Verb',
    'ISpPhoneticAlphabetSelection', 'ISpRecoContext',
    'ISpRecognizer3', 'SPEI_INTERFERENCE', 'SAFTADPCM_8kHzMono',
    'DISPID_SPPId', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRTEmulated',
    'DISPID_SRCRetainedAudioFormat', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SOTCGetDataKey', 'SITooLoud', 'ISpeechLexicon',
    'SVSFlagsAsync', 'DISPID_SRCBookmark', 'DISPID_SVGetProfiles',
    'DISPID_SRGCmdLoadFromFile', 'SPCT_SUB_DICTATION',
    'DISPID_SRAudioInput', 'DISPID_SpeechGrammarRule', 'SWTAdded',
    'SPEI_TTS_AUDIO_LEVEL', 'SPEI_ADAPTATION',
    'DISPID_SPEDisplayAttributes', 'SRSActiveAlways',
    'SAFT16kHz16BitMono', 'DISPID_SVSkip', 'DISPID_SWFEFormatTag',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRGDictationUnload',
    'DISPID_SDKDeleteValue', 'SRTStandard', 'SP_VISEME_17',
    'SpeechUserTraining', 'DISPID_SGRSTransitions', 'SP_VISEME_20',
    'SECFIgnoreCase', 'ISpAudio', 'SGLexicalNoSpecialChars',
    'SP_VISEME_1', 'ISpRecoResult', 'SRAORetainAudio',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SDKLLocalMachine',
    'ISpNotifyTranslator', 'ISpeechLexiconWord', 'ISpeechMMSysAudio',
    'ISpObjectToken', 'Speech_StreamPos_RealTime', 'SPVISEMES',
    'SPEI_RESERVED5', 'SpSharedRecognizer',
    'DISPID_SRGIsPronounceable', 'DISPID_SPPsCount',
    'DISPID_SVAlertBoundary', 'ISpeechRecoResultTimes',
    'eLEXTYPE_RESERVED8', 'DISPID_SBSFormat',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechDictationTopicSpelling', 'SPCT_SLEEP',
    'DISPID_SpeechLexicon', 'DISPID_SRCEFalseRecognition',
    'SpeechTokenIdUserLexicon', 'DISPID_SPARecoResult',
    'SPEI_VOICE_CHANGE', 'DISPID_SPRulesCount', 'SPDKL_CurrentUser',
    'DISPID_SpeechPhraseInfo', 'ISpDataKey',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SVVolume',
    'DISPID_SPIStartTime', 'SpeechAllElements', 'DISPID_SRGetFormat',
    'SAFT32kHz8BitMono', 'SVP_14', 'SpeechCategoryAudioOut',
    'ISequentialStream', 'DISPID_SVGetVoices', 'SRTReSent',
    'DISPID_SPACommit', 'IInternetSecurityManager', 'DISPID_SBSWrite',
    'DISPID_SBSRead', 'DISPID_SRCEPhraseStart', 'DISPID_SRRecognizer',
    'DISPID_SPRNumberOfElements', 'SpTextSelectionInformation',
    'SPCT_DICTATION', 'SVF_Stressed', 'SPSHORTCUTPAIR',
    'SDTLexicalForm', 'SPEI_SENTENCE_BOUNDARY', 'ISpLexicon',
    'DISPID_SGRs_NewEnum', 'SAFT48kHz8BitStereo',
    'DISPID_SVSPhonemeId', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SITooFast', 'SPAO_RETAIN_AUDIO',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVEWord', 'UINT_PTR',
    'SpeechCategoryVoices', 'STCLocalServer', 'SpeechRuleState',
    'DISPID_SRRAudioFormat', 'DISPID_SpeechPhraseProperty',
    'DISPID_SLPLangId', 'ISpeechAudio', 'DISPID_SDKDeleteKey',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechAudioBufferInfo',
    'SPINTERFERENCE_NOISE', 'SPWF_SRENGINE', 'DISPID_SRGRecoContext',
    'SPGRAMMARSTATE', 'SpInprocRecognizer', 'DISPID_SAFGuid',
    'DISPID_SRState', 'SPAR_Medium', 'ISpeechRecoContext',
    'SpeechVisemeType', 'SAFTADPCM_8kHzStereo',
    'SpeechVoiceSpeakFlags', 'DISPID_SPCPhoneToId',
    'DISPID_SpeechAudioFormat', 'DISPID_SPAsItem',
    'DISPID_SPIGetText', 'SAFT16kHz8BitStereo', 'SPPS_Modifier',
    'SPSHT_OTHER', 'SPPS_Interjection',
    'DISPID_SRGCmdLoadFromResource', 'SPVPRI_NORMAL',
    'SVSFIsFilename', 'SREFalseRecognition',
    'SWPKnownWordPronounceable', 'SAFTADPCM_11kHzStereo',
    'DISPID_SGRSTText', 'SVSFIsNotXML', 'SpLexicon',
    'DISPID_SPEActualConfidence', 'SPPS_LMA', 'SPEI_SR_RETAINEDAUDIO',
    'SVP_1', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPEsItem', 'SpeechVoiceSkipTypeSentence',
    'SpeechPropertyResponseSpeed', 'DISPID_SGRSTWeight',
    'SAFT24kHz16BitStereo', 'DISPID_SpeechPhoneConverter',
    'SGDSActive', 'SpeechCategoryPhoneConverters',
    'SDA_Consume_Leading_Spaces', 'eLEXTYPE_USER_SHORTCUT',
    'SP_VISEME_14', 'DISPID_SpeechFileStream',
    'DISPID_SpeechPhraseReplacements', 'SPBINARYGRAMMAR',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SOTsCount', 'SpeechRecoEvents',
    'SAFT32kHz16BitMono', 'SINone', 'SPFM_CREATE_ALWAYS', 'SVP_6',
    'DISPID_SVResume', 'DISPID_SGRName', 'SGDSActiveUserDelimited',
    'SPPS_Noncontent', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVSCurrentStreamNumber', 'SPINTERFERENCE_NOSIGNAL',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SABIBufferSize', 'SVP_11', 'DISPID_SpeechVoice',
    'SAFT16kHz8BitMono', 'SDA_One_Trailing_Space',
    'DISPID_SOTDisplayUI', 'SDTProperty', 'SPAR_Low', 'SGRSTTWord',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPINTERFERENCE_TOOLOUD', 'SAFTExtendedAudioFormat',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SDKEnumValues',
    'DISPID_SVPriority', 'SpeechSpecialTransitionType',
    'DISPID_SRGId', 'SPBO_AHEAD', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SOTs_NewEnum', 'SpeechAudioFormatGUIDText',
    'ISpeechVoice', 'DISPID_SPIRetainedSizeBytes', 'SRAONone',
    'SP_VISEME_10', 'SVSFParseAutodetect', 'SpeechTokenKeyFiles',
    'DISPID_SDKSetStringValue', 'SPSERIALIZEDRESULT',
    'SREPropertyNumChange', 'SpeechVoiceEvents', 'SLTUser',
    'SGSDisabled', 'eLEXTYPE_PRIVATE1', 'DISPID_SPERetainedSizeBytes',
    'SPEI_MIN_TTS', 'SRATopLevel', 'SVF_Emphasis',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechRecoResultDispatch',
    'SAFT11kHz8BitStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechLexiconWords', 'SPSHT_NotOverriden',
    'SpeechDataKeyLocation', 'DISPID_SVEAudioLevel', 'SP_VISEME_19',
    'STCInprocHandler', 'SPDKL_DefaultLocation', 'SSFMOpenForRead',
    'SPWORD', 'SDTDisplayText', 'SPFM_NUM_MODES', 'SPAUDIOOPTIONS',
    'DISPID_SLPSymbolic', 'SINoSignal', 'ISpeechGrammarRuleState',
    'SAFT8kHz8BitMono', 'ISpeechRecoResult',
    'SSSPTRelativeToCurrentPosition', 'SRSEDone',
    'ISpObjectTokenCategory', 'DISPID_SVRate', 'SPXRO_Alternates_SML',
    'ISpeechAudioStatus', 'DISPID_SPPsItem', 'SVP_13',
    'SVEStartInputStream', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRRGetXMLResult', 'SpMMAudioEnum',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVSpeakCompleteEvent',
    'SITooSlow', 'SPEI_FALSE_RECOGNITION', 'SREInterference',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTRemoveStorageFileName',
    'SREPrivate', 'SECFEmulateResult', 'SGSExclusive', 'SRCS_Enabled',
    'SPRECORESULTTIMES', 'SPBO_PAUSE', 'DISPID_SRGCommit',
    'SVSFUnusedFlags', 'SSSPTRelativeToEnd', 'SPWT_DISPLAY',
    'ISpEventSink', 'SPPHRASE', 'SpeechRecognizerState', 'SpVoice',
    'ISpPhoneConverter', 'DISPID_SABIMinNotification',
    'DISPID_SADefaultFormat', 'DISPID_SASFreeBufferSpace',
    'ISpeechRecognizerStatus', 'DISPID_SGRSTRule',
    'SPINTERFERENCE_TOOSLOW', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpPhrase', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPPNumberOfElements', 'DISPID_SLPsCount',
    'SpeechRecoContextState', 'SRCS_Disabled',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRGetRecognizers',
    'SVEAudioLevel', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SECLowConfidence', 'SpeechRecognitionType', 'SREStreamEnd',
    'SVP_5', 'SRERequestUI', 'SAFT24kHz8BitStereo',
    'DISPID_SDKGetStringValue', 'DISPID_SPEDisplayText', 'SPSMF_UPS',
    'DISPID_SPPs_NewEnum', 'SRERecoOtherContext',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_PRIVATE15', '_SPAUDIOSTATE',
    'SRSInactiveWithPurge', 'DISPID_SLGetGenerationChange',
    'SPLEXICONTYPE', 'SGSEnabled', 'DISPID_SRCEventInterests',
    'DISPID_SOTGetDescription', 'SpStream', 'eLEXTYPE_PRIVATE19',
    'DISPID_SGRsDynamic', 'SVP_16', 'SVP_7',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SLPsItem', 'DISPID_SPIRule'
]

_check_version('1.1.13', 1652442272.483569)
